...
#   docker build --build-arg GITLAB_IMAGE=gitlab/gitlab-ee:18.10.1-ee.0 -t gitlab-ee-skript:18.10.1 .
#
# You can also use CE:
#   docker build --build-arg GITLAB_IMAGE=gitlab/gitlab-ce:<version>-ce.0 -t gitlab-ce-skript:<version> .
